...
A restrição municipal vale para o produto atual inteiro, não apenas para M0–M1.
...
| [`../schemas/corpus_process.v0.1.0.json`](../schemas/corpus_process.v0.1.0.json) | Manifesto externo de perfil e escopo municipal |
